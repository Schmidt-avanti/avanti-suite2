...
const TaskDetail = () => {
  ...
  const [interfaceMode, setInterfaceMode] = useState<'selection' | 'workflow' | 'manual' | 'legacy'>('selection');
  ...
  if (interfaceMode === 'selection') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
        <SmartUseCaseSelection
          taskId={task.id}
          customerId={task.customer_id}
          taskDescription={task.description}
          taskTitle={task.title}
          onUseCaseSelected={handleUseCaseSelected}
          onManualProcessing={handleManualProcessing}
        />
      </div>
    );
  }
  ...
  if (interfaceMode === 'workflow' && selectedUseCaseId) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
        <SmartWorkflowInterface
          taskId={task.id}
  ...
  if (interfaceMode === 'manual') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-yellow-50">
        <ManualProcessingInterface
          taskId={task.id}
          taskTitle={task.title}
          taskDescription={task.description}
          onBackToSelection={handleBackToSelection}
